  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {!imgLoaded && !imgError && product.image_url && (
        ...
        <div style={{
          ...
          {product.description && (
            <div style={{
              ...
              <p style={{
                color: '#6aa0bc', fontSize: '0.875rem',
          ...
          <div>
            <p style={{
              ...
              letterSpacing: '0.12em', color: '#3d7090',
              margin: '0 0 0.75rem',
            }}>
              Contactar / Comprar
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              {product.wallapop_url && (
                <ActionLink
                  href={product.wallapop_url}
                  color="#f15a24"
                  label="Ver en Wallapop"
                  icon={
              ...
              <ActionLink
                href={emailUrl}
                color="#5cc8e0"
                label="Enviar email (con asunto ya escrito)"
                target="_self"
                icon={
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      ...
      <style>{`
        @media (max-width: 600px) {
          ...
          .modal-img-panel { width: 100% !important; min-height: 240px !important; max-height: 260px; }
        }
      `}</style>
    </div>
  )
